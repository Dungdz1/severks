...
{
    /// <inheritdoc />
    public partial class fullnon : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderUsers_AuthUser_UserId",
                        column: x => x.UserId,
                        principalSchema: "auth",
                        principalTable: "AuthUser",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    SaleId = table.Column<int>(type: "int", nullable: false),
                    ProdProductId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProdSale_ProdProduct_ProdProductId",
                        column: x => x.ProdProductId,
                        principalSchema: "prod",
                        principalTable: "ProdProduct",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProdSale_ProdProductId",
                schema: "prod",
                table: "ProdSale",
                column: "ProdProductId");
